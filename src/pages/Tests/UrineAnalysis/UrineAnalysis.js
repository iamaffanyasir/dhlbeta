...
import './urine-analysis.css';

const UrineAnalysis = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Complete Urine Analysis</h1>
        <p className="test-page__subtitle">Comprehensive urine examination</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Comprehensive urine examination This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Use sterile container</li>
            <li>First morning sample preferred</li>
            <li>Follow collection instructions</li>
          </ul>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have urinary symptoms</li>
            <li>Need kidney function check</li>
            <li>Have diabetes</li>
            <li>Experience frequent infections</li>
          </ul>
