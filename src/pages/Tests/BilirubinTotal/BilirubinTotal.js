...
import './bilirubin-total.css';

const BilirubinTotal = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Bilirubin (Total)</h1>
        <p className="test-page__subtitle">Measures total bilirubin levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures total bilirubin levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Inform about supplements</li>
          </ul>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have jaundice</li>
            <li>Experience liver problems</li>
            <li>Have gallbladder issues</li>
            <li>Need liver function monitoring</li>
          </ul>
