...
import './bun-creatinine-ratio.css';

const BunCreatinineRatio = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">BUN/Creatinine Ratio Test</h1>
        <p className="test-page__subtitle">Evaluates the ratio between blood urea nitrogen and creatinine</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Evaluates the ratio between blood urea nitrogen and creatinine This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Avoid excessive protein intake</li>
          </ul>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Need kidney function evaluation</li>
            <li>Have abnormal BUN or creatinine levels</li>
            <li>Experience dehydration</li>
            <li>Have acute kidney injury</li>
          </ul>
        ...
        <div className="test-page__book">
          ...
          <div className="test-page__booking">
            <div className="test-page__price">
              <span className="test-page__price-current">₹299</span>
              <span className="test-page__price-original">₹599</span>
...
export default BunCreatinineRatio;