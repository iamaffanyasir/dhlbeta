  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">A/G Ratio</h1>
        <p className="test-page__subtitle">Measures the ratio of albumin to globulin</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures the ratio of albumin to globulin This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Experience protein disorders</li>
            <li>Have kidney problems</li>
            <li>Need protein balance assessment</li>
          </ul>
