  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Chloride Test</h1>
        <p className="test-page__subtitle">Measures chloride levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures chloride levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have electrolyte imbalances</li>
            <li>Experience frequent vomiting</li>
