...
import './bilirubin-indirect.css';

const BilirubinIndirect = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Bilirubin (Indirect)</h1>
        <p className="test-page__subtitle">Measures indirect bilirubin levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures indirect bilirubin levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have hemolytic anemia</li>
            <li>Experience jaundice</li>
            <li>Have liver problems</li>
            <li>Need liver function assessment</li>
          </ul>
...
export default BilirubinIndirect;