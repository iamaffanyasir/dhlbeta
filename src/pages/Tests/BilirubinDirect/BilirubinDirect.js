...
import './bilirubin-direct.css';

const BilirubinDirect = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Bilirubin (Direct)</h1>
        <p className="test-page__subtitle">Measures direct bilirubin levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures direct bilirubin levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Experience jaundice</li>
            <li>Have bile duct problems</li>
            <li>Need detailed liver assessment</li>
          </ul>
...
export default BilirubinDirect;