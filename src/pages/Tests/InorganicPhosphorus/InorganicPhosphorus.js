...
import './inorganic-phosphorus.css';

const InorganicPhosphorus = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Inorganic Phosphorus Test</h1>
        <p className="test-page__subtitle">Measures phosphorus levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures phosphorus levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Avoid phosphate-rich foods</li>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Experience bone disorders</li>
            <li>Have parathyroid issues</li>
            <li>Need mineral balance monitoring</li>
          </ul>
...
export default InorganicPhosphorus;