  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Sodium (NA+) Test</h1>
        <p className="test-page__subtitle">Measures sodium levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures sodium levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Take diuretics</li>
            <li>Have electrolyte imbalance symptoms</li>
          </ul>
