...
import './total-protein.css';

const TotalProtein = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Total Protein</h1>
        <p className="test-page__subtitle">Measures total protein levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures total protein levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
