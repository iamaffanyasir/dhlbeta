...
import './blood-sugar-fasting.css';

const BloodSugarFasting = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Blood Sugar (Fasting)</h1>
        <p className="test-page__subtitle">Measures blood glucose levels after fasting</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures blood glucose levels after fasting This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Only water is allowed during fasting</li>
            <li>Continue medications as prescribed</li>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have diabetes symptoms</li>
            <li>Need diabetes monitoring</li>
            <li>Have family history of diabetes</li>
        ...
        <div className="test-page__book">
          ...
          <div className="test-page__booking">
            <div className="test-page__price">
              <span className="test-page__price-current">₹149</span>
              <span className="test-page__price-original">₹299</span>
