...
import './serum-calcium.css';

const SerumCalcium = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Calcium Test</h1>
        <p className="test-page__subtitle">Measures calcium levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures calcium levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have bone disorders</li>
            <li>Experience muscle weakness</li>
            <li>Have kidney stones</li>
            <li>Need calcium level monitoring</li>
          </ul>
