...
import './blood-urea.css';

const BloodUrea = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Blood Urea Test</h1>
        <p className="test-page__subtitle">Measures the amount of urea nitrogen in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures the amount of urea nitrogen in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have symptoms of kidney problems</li>
            <li>Are being monitored for kidney disease</li>
            <li>Have high blood pressure or diabetes</li>
            <li>Need regular kidney function monitoring</li>
          </ul>
