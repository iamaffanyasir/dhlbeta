...
import './uric-acid.css';

const UricAcid = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Uric Acid Test</h1>
        <p className="test-page__subtitle">Measures uric acid levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures uric acid levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            <li>Fast for 8 hours before the test</li>
            <li>Avoid alcohol for 24 hours</li>
            <li>Continue medications as prescribed</li>
            <li>Inform about any supplements</li>
          </ul>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have gout symptoms</li>
            <li>Have kidney stones</li>
            <li>Experience joint pain</li>
            <li>Need gout monitoring</li>
          </ul>
