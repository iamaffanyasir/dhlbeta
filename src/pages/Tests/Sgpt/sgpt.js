  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">SGPT Test</h1>
        <p className="test-page__subtitle">Measures SGPT enzyme levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures SGPT enzyme levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Experience unexplained fatigue</li>
            <li>Need liver health monitoring</li>
          </ul>
