  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Potassium (K+) Test</h1>
        <p className="test-page__subtitle">Measures potassium levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures potassium levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have heart rhythm problems</li>
            <li>Take certain medications</li>
            <li>Have kidney disease</li>
            <li>Experience muscle weakness</li>
          </ul>
