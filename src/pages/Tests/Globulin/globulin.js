  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Globulin</h1>
        <p className="test-page__subtitle">Measures globulin levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures globulin levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have immune system disorders</li>
            <li>Experience chronic infections</li>
            <li>Have liver problems</li>
            <li>Need protein assessment</li>
          </ul>
