  ...
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">GGT Test</h1>
        <p className="test-page__subtitle">Measures GGT enzyme levels in blood</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures GGT enzyme levels in blood This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            ...
            <li>Need liver enzyme monitoring</li>
          </ul>
