...
import './serum-creatinine.css';

const SerumCreatinine = () => {
  return (
    <div className="test-page">
      <div className="test-page__header">
        <h1 className="test-page__title">Serum Creatinine Test</h1>
        <p className="test-page__subtitle">Measures creatinine levels in blood to assess kidney function</p>
      </div>
      ...
      <div className="test-page__content">
        ...
        <div className="test-page__section">
          ...
          <p>
            Measures creatinine levels in blood to assess kidney function This test is an essential diagnostic tool that helps healthcare providers:
          </p>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__preparation">
            ...
            <li>Continue medications unless advised otherwise</li>
        ...
        <div className="test-page__section">
          ...
          <ul className="test-page__when">
            <li>Have kidney disease symptoms</li>
            <li>Are taking medications that may affect kidney function</li>
            <li>Have diabetes or high blood pressure</li>
            <li>Need regular kidney monitoring</li>
          </ul>
        ...
        <div className="test-page__book">
          ...
          <div className="test-page__booking">
            <div className="test-page__price">
              <span className="test-page__price-current">₹249</span>
              <span className="test-page__price-original">₹499</span>
